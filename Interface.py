...
class ImageResizerGUI:
    def __init__(self, master):
        ...
        self.browse_button.grid(row=0, column=0, padx=10, pady=5, sticky="nsew")

        self.save_button = tk.Button(master, text="Save Miniship", command=self.browse_output)
        self.save_button.grid(row=0, column=1, padx=10, pady=5, sticky="nsew")

        # Create canvas for image display
        self.canvas = tk.Canvas(master, width=200, height=200)
        self.canvas.grid(row=2, column=3, rowspan=3, padx=10, pady=5, sticky="nsew")
        ...
        self.search_entry.grid(row=3, column=1, padx=10, pady=5, sticky="nsew")
...
if __name__ == "__main__":
    ...
    # Set the current size as the minimum
